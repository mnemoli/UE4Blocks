...
public class Blocks : ModuleRules
{
    ...
    public Blocks(TargetInfo Target)
	{
        ...
        PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "InputCore", "ProceduralMeshComponent", "ShaderCore", "RenderCore", "RHI", "RuntimeMeshComponent", "Json", "JsonUtilities" });
